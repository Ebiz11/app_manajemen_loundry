...
$kredit1=$_POST['modal'];
  ...
  VALUES('$_POST[modal]','$kredit1', '$ket1')");
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal">
                    <div class="form-group"><label class="col-sm-2 control-label">Nama Investor</label>
                      <div class="col-sm-5">
                        <div class="col-sm-10"><input type="text" name="nama_investor" class="form-control" required></div>
                    </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Modal</label>
                      <div class="col-sm-5">
                        <div class="col-sm-10"><input type="text" name="modal" class="form-control" required></div>
                    </div>
                    </div>
