        ...
        <div class="row">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Laporan Pendapatan Masuk</h5>
                ...
                <tbody>
                  <?php
                      $no=1;
                      $querylaporan = $dbh->query( "SELECT * FROM detail_transaksi WHERE st_bayar='1' ORDER BY nota");
                ...
                <tr>
                  ...
                  <th>Total</th>
                  <?php
                  $totalnya=$dbh->query("SELECT SUM(total) AS total FROM detail_transaksi WHERE st_bayar='1'");
